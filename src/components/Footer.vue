			...
			<footer id="footer">
				<div>
					...
					<div class="jis">
						<p>
							Site by
							<a href="" target="_blank">Codeworks Bangladesh</a>
						</p>
					</div>
				</div>
			</footer>
...
.index_footer::before {
	...
	width: 349px;
	height: 364px;
	background: url('../assets/left_bottom_star_bg.svg') no-repeat 0 0;
	position: absolute;
	left: 0;
	bottom: 0;
}
...
.footer_map h3 {
	...
	line-height: 1.35;
	color: #fff;
	background: url('../assets/map_white_pin.svg') no-repeat 50% 0;
}
.footer_map p {
	padding: 0 0 35px;
	font-size: 14px;
